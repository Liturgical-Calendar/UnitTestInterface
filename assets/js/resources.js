...
const resourceTemplate = (resource, idx) => `<div class="col-1 ${idx === 0 || idx % 11 === 0 ? 'offset-1' : ''}">
    <div class="text-center mt-2 mb-0 bg-secondary text-white h-25"><span title="${resourcePaths[resource]}" class="text-break d-inline-block w-75">${resourcePaths[resource]}</span></div>
...
<div class="text-center mt-2 mb-0 bg-secondary text-white h-25"><span title="${sourceItem.sourceFile ?? sourceItem.sourceFolder}" class="text-break d-inline-block w-75">${sourceItem.validate}</span></div>
