...
**Web-based graphical test interface** for validating the LiturgicalCalendarAPI. Connects via **WebSocket** to a test server
(the API's `Health.php` Ratchet websocket), runs unit tests asynchronously, and renders results in real time on a responsive
