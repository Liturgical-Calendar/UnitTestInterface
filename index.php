    ...
    <div class="container-fluid">
        ...
        <div id="testsContainer">
            <div class="row mb-3 text-center g-3 litcaltests-header align-items-center justify-content-center">
                <div class="col-2">
                    <label for="APICalendarSelect">Liturgical Calendar</label>
                ...
                <div class="col-2"><button id="startTestRunnerBtn" type="button" class="btn btn-primary" disabled><i class="fa fa-rotate fa-fw d-inline-block"></i> Run Tests</button></div>
                <div class="col-1"></div>
                ...
                <div class="col-3 text-white bg-dark p-2"><i class="fas fa-stopwatch fa-fw"></i> Total time for <span id="total-tests-count"></span> tests: <span id="total-time">0 seconds, 0ms</span></div>
            </div>
                ...
                <div class="accordion-item">
                    <h2 class="row g-0 accordion-header" id="sourceDataHeader">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#sourceDataTests" aria-expanded="true" aria-controls="sourceDataTests">
                            ...
                            <div class="col-3 text-white p-2 text-center test-results bg-dark"><i class="fas fa-stopwatch fa-fw"></i> Total time for <span id="totalSourceDataTestsCount"></span> tests: <span id="totalSourceDataTestsTime">0 seconds, 0ms</span></div>
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="row g-0 accordion-header" id="calendarDataHeader">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#calendarDataTests" aria-expanded="false" aria-controls="calendarDataTests">
                            ...
                            <div class="col-3 text-white p-2 text-center test-results bg-dark"><i class="fas fa-stopwatch fa-fw"></i> Total time for <span id="totalCalendarDataTestsCount"></span> tests: <span id="totalCalendarDataTestsTime">0 seconds, 0ms</span></div>
                        </button>
                    </h2>
                ...
                <div class="accordion-item">
                    <h2 class="row g-0 accordion-header" id="specificUnitTestHeader">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#specificUnitTests" aria-expanded="false" aria-controls="specificUnitTests">
                            ...
                            <div class="col-3 text-white p-2 text-center test-results bg-dark"><i class="fas fa-stopwatch fa-fw"></i> Total time for <span id="totalUnitTestsCount"></span> tests: <span id="totalUnitTestsTime">0 seconds, 0ms</span></div>
                        </button>
                    </h2>
